                ...
                <form className="flex w-full md:ml-0" action="#" method="GET">
                  ...
                  <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                    ...
                    <input
                      id="search-field"
                      name="search-field"
                      className="block w-full h-full py-2 pl-8 pr-3 text-gray-900 border-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm"
              ...
              <div className="shadow sm:hidden">
                ...
                >
                  <div className="flex justify-between flex-1">
                    <a
                      href="#"
                      className="relative inline-flex items-center px-3 py-2 text-sm font-semibold text-gray-900 bg-white rounded-md ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                    >
                      Previous
                    </a>
                    <a
                      href="#"
                      className="relative inline-flex items-center px-3 py-2 ml-3 text-sm font-semibold text-gray-900 bg-white rounded-md ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                    >
                      Next
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col mt-2">
                    <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                      ...
                      >
                        ...
                        <div className="flex justify-between flex-1 gap-x-3 sm:justify-end">
                          <a
                            href="#"
                            className="relative inline-flex items-center px-3 py-2 text-sm font-semibold text-gray-900 bg-white rounded-md ring-1 ring-inset ring-gray-300 hover:ring-gray-400"
                          >
                            Previous
                          </a>
                          <a
